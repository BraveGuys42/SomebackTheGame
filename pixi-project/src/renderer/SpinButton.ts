...
export class SpinButton extends Container {
    ...
    constructor() {
        ...
        this.bg = new Graphics().ellipse(0, 0, this.buttonSize / 2,this.buttonSize / 2).fill(0xffffff);
        ...
        // Center everything in a clean coordinate system
        this.bg.position.set(0, 0);
        this.fg.position.set(0, 0);

        // Pivot for whole button
